"""
Django settings for UserPNS_1184077 project.
...
SECRET_KEY = '=)1jyq)^a+pdq1nh9ht(x)@+t8$y^!ws&l0!y+0*z^4+4s8gb+'
...
ROOT_URLCONF = 'UserPNS_1184077.urls'
...
WSGI_APPLICATION = 'UserPNS_1184077.wsgi.application'
